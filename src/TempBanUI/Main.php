			...
			case "tban":
				if($sender instanceof Player) {
					if($sender->hasPermission("use.tban")){
						...
						$form->addStepSlider("Reason", 1, "Fly hacking / Jesus hacks / Other fly related offenses", "Speed hacking", "Reach / Aura hacks", "XRay / Chest ESP", "Bhop/scaffold", "Toolbox/duping", "Auto Clicking", "Spawn Killing", "STR Grinding", "Bug abuse", "Threatening the server");
